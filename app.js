...
import('./wave.js?v=149').then(({WaveField})=>{wave=new WaveField(document.getElementById('ocean'),still);wave.setScene(location.hash.startsWith('#/contact')?2:location.hash.startsWith('#/works')?1:0);}).catch(console.error);